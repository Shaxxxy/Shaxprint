 ...
 */
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD 260                // Seconds
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD 260    // Seconds
  #define THERMAL_PROTECTION_BED_HYSTERESIS 2 // Degrees Celsius

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD 260                // Seconds
...
#define LIN_ADVANCE
   ...
   */
  #define LIN_ADVANCE_E_D_RATIO 0.037418756 // The calculated ratio (or 0) according to the formula W * H / ((D / 2) ^ 2 * PI)
...
#define FWRETRACT  // ONLY PARTIALLY TESTED
  ...
  #define MIN_AUTORETRACT 1             // When auto-retract is on, convert E moves of this length and over
  ...
  #define RETRACT_ZLIFT 0.20                 // Default retract Z-lift
...
/**
 * Enable this for SilentStepStick Trinamic x2130 SPI-configurable stepper drivers.
 *
